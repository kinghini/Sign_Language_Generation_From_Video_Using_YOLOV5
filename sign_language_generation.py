# -*- coding: utf-8 -*-
"""Sign language Generation.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1dkexlP0TZVWWobgCUA6Vp01hLQuaX7V0
...
# %cd /content 
!curl -L "https://github.com/kinghini/Sign_Language_Generation_From_Video_Using_YOLOV5/raw/main/Sign_yolo.zip" > SignData.zip; unzip SignData.zip; rm SignData.zip
...
# %cd /content/yolov5/
!python detect.py --weights /content/yolov5/runs/train/yolov5s_results4/weights/best.pt --img 416 --conf 0.5 --source ../test/images
